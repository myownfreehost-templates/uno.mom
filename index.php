...
<a class="btn btn-outline-secondary" href="http://<?echo $yourdomain;?>"><?echo $yourdomain;?></a> <a class="btn btn-light" href="javascript:freehosting('show');">Free Hosting</a></div>
