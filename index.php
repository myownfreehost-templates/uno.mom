...
<form class="row justify-content-center" style='position: absolute; left: 0; right: 0; top: 20%; margin-top: -50px; width: auto; height: auto; padding: 10px; margin: 10px; color: black; font-size: 14px;'><div class="col-auto"><div class="form-control alert alert-primary opacity-75" role="alert">
უფასო ვებ ჰოსტინგი PHP მხარდაჭერით და უფასო ქვე-დომენით</div></div>
</form>
<form method="GET" action="index.php" class="row opacity-75 shadow p-3 mb-5 bg-body-tertiary rounded justify-content-center" style='background-color: #f1f1f1; padding: 5px; margin: 5px; position: absolute; top: 50%; left: 0; right: 0; margin-top: -50px; width: auto; height: auto;'>
