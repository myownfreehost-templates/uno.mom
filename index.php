...
<form method="GET" action="index.php" class="row justify-content-center" style='position: absolute; top: 50%; left: 0; right: 0; margin-top: -50px; width: auto; height: auto;'>
