...
<div class="col"><p>
<div class="card">
<h6 class="card-header">Features</h6>
  <div class="card-body">
<div class="input-group mb-3">
<ul><li><font color="green"><small>5GB</small></font> Disk space</li>
<li>Unlimited traffic</li>
<li>Daily hits limit <font color="red"><small>50,000</small></font></li>
<li>Free subdomain <font color="blue"><small>.fh.wiki</small></font></li>
<li>PHP version <font color="gray"><small><?php echo phpversion(); ?></small></font></li></ul>
</div>
...
<a class="btn btn-outline-secondary" href="http://<?echo $yourdomain;?>"><?echo $yourdomain;?></a> <a class="btn btn-secondary" href="javascript:freehosting('show');">Free Hosting</a></div>
