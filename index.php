...
<li>PHP version <font color="gray"><small><?php echo phpversion(); ?></small></font></li>
<li>Price $ 0.00 monthly</li></ul>
</div>
<div class="input-group mb-3">
...
<a class="btn btn-outline-secondary" href="http://<?echo $yourdomain;?>"><?echo $yourdomain;?></a> <a class="btn btn-light" href="javascript:freehosting('show');">Features</a></div>
