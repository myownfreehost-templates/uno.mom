...
<form class="row opacity-100 shadow-none mb-5 bg-body-tertiary rounded justify-content-center" action="http://cpanel.<?echo $yourdomain;?>/login.php" method="post">
<h6><span class="badge text-bg-dark">Control Panel - Login</span></h6>
<div class="input-group mb-3">
<input placeholder="Username" class="form-control" type="text" name="uname" maxlength="30" oninvalid="this.setCustomValidity('Enter username')" oninput="setCustomValidity('')" required></div>

<div class="input-group mb-3">
<input placeholder="Password" class="form-control" type="password" name="passwd" maxlength="30" oninvalid="this.setCustomValidity('Enter password')" oninput="setCustomValidity('')" required></div>
...
Free Web Hosting with Free Subdomain</div></div>
</form>
<form method="GET" action="index.php" class="row opacity-100 shadow-none mb-5 bg-body-tertiary rounded justify-content-center" style='background-color: #fafafa; padding: 5px; margin: 5px; position: absolute; top: 50%; left: 0; right: 0; margin-top: -50px; width: auto; height: auto;'>
<div class="col-auto"><div class="input-group mb-3">
<span class="input-group-text">http://</span><input type='text' class="form-control" placeholder="Subdomain" value="<?echo $subdomain;?>" pattern="[a-z0-9]{4,16}" maxlength="16" oninvalid="this.setCustomValidity('Enter sub-domain')" oninput="setCustomValidity('')" name="subdomain" id="hostname" required>
...
<div class="col-auto">
<a class="btn btn-outline-dark" type="button" href="signup.php?subdomain=<?echo $subdomain;?>">Register <?echo $subdomain;?>.<?echo $yourdomain;?></a></div></div></center>
</form>
