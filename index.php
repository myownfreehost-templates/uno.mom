...
<a class="btn btn-danger" style="position: absolute; right: 0;" href="javascript:login('hide');">x</a>
<form style="border: 3px solid blue; background-color: #afafaf;" class="row opacity-100 shadow p-3 mb-5 bg-body-tertiary rounded justify-content-center" action="https://cpanel.<?echo $yourdomain;?>/login.php" method="post"><div style="text-align: center;">
    <div style="text-align: left; display: inline-block;">
<div class="col-auto"><div class="input-group mb-3"><hr>
<input placeholder="მომხმარებელი" class="form-control" type="text" name="uname" maxlength="30" /></div></div>
<div class="col-auto">
<div class="input-group mb-3">
<input placeholder="პაროლი" class="form-control" type="password" name="passwd" maxlength="30" /></div></div>
<div class="input-group mb-3">
...
<form method="GET" action="index.php" class="row opacity-100 shadow p-3 mb-5 bg-body-tertiary rounded justify-content-center" style='background-color: #efefef; padding: 5px; margin: 5px; position: absolute; top: 50%; left: 0; right: 0; margin-top: -50px; width: auto; height: auto;'>
