...
<form method="GET" action="signup.php" class="row opacity-100 shadow-none mb-5 bg-body-tertiary rounded justify-content-center" style='background-color: #fafafa; padding: 5px; margin: 5px; position: absolute; top: 50%; left: 0; right: 0; margin-top: -50px; width: auto; height: auto;'>
<div class="col-auto"><div class="input-group mb-3">
<span class="input-group-text">http://</span><input type='text' name="subdomain" class="form-control" placeholder="Enter sub-domain" value="<?echo $subdomain;?>" pattern="[a-z0-9]{4,16}" maxlength="16" oninvalid="this.setCustomValidity('Enter sub-domain')" oninput="setCustomValidity('')" name="subdomain" id="hostname" required>
