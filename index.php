...
<input placeholder="მომხმარებელი" class="form-control" type="text" name="uname" maxlength="30" /></div>

<div class="input-group mb-3">
<input placeholder="პაროლი" class="form-control" type="password" name="passwd" maxlength="30" /></div>

<div class="input-group mb-3">
<input type="submit" name="submit" class="btn btn-warning" value="შესვლა" /></div>

<div class="input-group mb-3">
<span class="input-group-text">აირჩიეთ ენა</span><select class="form-select" name="language">
