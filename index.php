...
<input type='text' class="form-control" placeholder="ქვე-დომენი" type=text value="" pattern="[a-z0-9]{4,16}" maxlength="16" oninvalid="this.setCustomValidity('Enter sub-domain')" oninput="setCustomValidity('')" name='subdomain' id="hostname" required>
