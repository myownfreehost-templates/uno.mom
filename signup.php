...
<div class="container">
<div class="row">
<div class="col mb-3"><p>
<div class="card">
<form method=post action="http://order.<?echo $yourdomain;?>/register2.php">
<h6 class="card-header">Free Hosting - Sign Up</h6>
  <div class="card-body">
<div class="input-group mb-3">
<input placeholder="Enter sub-domain name" type=text class="form-control" name=username value="<?echo $subdomain;?>" pattern="[a-z0-9]{4,16}" maxlength="16" oninvalid="this.setCustomValidity('Enter sub-domain')" oninput="setCustomValidity('')" required>  <span class="input-group-text">.<?echo $yourdomain;?></span>
</div>
